...
//Click detectors
	...
	public void mouseClicked(MouseEvent e) {
	    ...
	    if (e.getX() < 3*(getWidth()/6)+10){
	    	if(3*(getWidth()/6)-40<e.getX()){
	    		if(e.getY() < (5*(getHeight()/6)+50)){
	    			if(5*(getHeight()/6)<e.getY()){
	    ...
	    if (e.getX() < 3*(getWidth()/6)+10){
	    	if(3*(getWidth()/6)-40<e.getX()){
	    		if(e.getY() < (1*(getHeight()/6)+20)){
	    			if(1*(getHeight()/6)-30<e.getY()){
	    ...
	    if (e.getX() < 1*(getWidth()/6)+30){
	    	if(1*(getWidth()/6)-20<e.getX()){
	    		if(e.getY() < (3*(getHeight()/6)+50)){
	    			if(3*(getHeight()/6)<e.getY()){
	    ...
	    if (e.getX() < 5*(getWidth()/6)+30){
	    	if(5*(getWidth()/6)-20<e.getX()){
	    		if(e.getY() < (3*(getHeight()/6)+50)){
	    			if(3*(getHeight()/6)<e.getY()){
	    ...
	    if (e.getX() < 2*(getWidth()/6)+5){
	    	if(2*(getWidth()/6)-20<e.getX()){
	    		if(e.getY() < 4*(getHeight()/6)+25){
	    			if(4*(getHeight()/6)<e.getY()){
	    ...
	    if (e.getX() < 4*(getWidth()/6)+5){
	    	if(4*(getWidth()/6)-20<e.getX()){
	    		if(e.getY() < 4*(getHeight()/6)+25){
	    			if(4*(getHeight()/6)<e.getY()){
	    ...
	    if (e.getX() < 2*(getWidth()/6)+5){
	    	if(2*(getWidth()/6)-20<e.getX()){
	    		if(e.getY() < 2*(getHeight()/6)+25){
	    			if(2*(getHeight()/6)<e.getY()){
